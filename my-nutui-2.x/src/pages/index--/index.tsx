...
function Index() {
  ...
  return (
    <View className="nutui-react-demo">
      ...
      <Button onClick={() => setVisible(true)}>打开Dialog-锁定背景滚动</Button>
      <Button onClick={() => setVisible2(true)}>
        打开Dialog-不锁定背景滚动
      </Button>

      <Dialog
        title="打开Dialog-锁定背景滚动"
        visible={visible}
        footer={null}
        lockScroll
      >
      ...
      <Dialog
        title="打开Dialog-不锁定背景滚动"
        visible={visible2}
        footer={null}
        lockScroll={false}
      >
        <Button onClick={() => setShow8(true)}> 选择日期</Button>
        <Button onClick={() => setVisible2(false)}>关闭dialog</Button>
      </Dialog>
      ...
      {/* <Upload
        ...
        fileList={fileList}
        onChange={() => {
          console.log("sard onchange");
        }}
        afterRead={handleAfterRead}
        select={
          <>
            <Download size={20} family="demo-icons" name="camera" />
      ...
      <ConfigProvider
        theme={{
          nutuiPickerItemHeight: "88px",
          nutuiPickerItemActiveTextColor: "#ff79ab",
          nutuiPickerItemActiveLineBorder: "#ff79ab",
          nutuiPickerItemTextColor: "#ff79ab",
        }}
      >
        <DatePicker
          visible={show8}
